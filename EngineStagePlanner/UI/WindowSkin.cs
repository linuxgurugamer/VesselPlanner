    ...
    internal static class WindowSkin
    {
        ...
        public static void Load()
        {
            try
            {
                ...
                path = Path.Combine(path, "EngineStagePlanner");
                path = Path.Combine(path, "PluginData");
                path = Path.Combine(path, "EngineStagePlannerSettings.cfg");
            ...
            {
                Debug.LogWarning("[EngineStagePlanner] Unable to load skin setting: " + ex.Message);
            }
        }
    }
}
